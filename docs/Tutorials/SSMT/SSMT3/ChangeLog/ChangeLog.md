...
::: info 📝 发布规则变更
**V3.2.8** 之后的 **SSMT** 遵循如下发布规则:

- 🚀 在 **SSMT技术社群** 中持续发布 **内测版**。
- 🧪 技术社群内发布的内测版会经历 **30天** 的测试与改进后，在 **Github** 上免费公开一个持续一个月的 **STS (Short Time Support)** 版本。你可以理解为工具变成了 **月更**，且更加 **稳定可靠**。
- 🔒 工具 **闭源** 以确保用户使用工具的 `安全性`，以及提供其它便利，防止用户下载到来源不明的 **风险软件**。
- 🐛 **SSMT内测版** 开发完成后，会首先在技术社群中进行 **内部测试**，经过多轮建议反馈以及使用测试，确保没有 **BUG** 后，在 **30天后** 发布的版本将是 **稳定可短期使用** 的 **正式版**。
- 🆓 **SSMT本体** 仍然是 **免费** 的，我们希望通过这种方式来让频繁使用的 **核心用户** 先一步进行测试，以确保 **正式版** 的发布能尽可能减少 **BUG**。
:::
